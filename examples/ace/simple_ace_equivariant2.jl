...
cD = conj.(WignerD.wignerD(2, θ...))
cD1 = conj.(WignerD.wignerD(1, θ...))
rD = real.(ET.O3.Ctran(2) * cD * ET.O3.Ctran(2)')
rD1 = real.(ET.O3.Ctran(1) * cD1 * ET.O3.Ctran(1)')
...
## 
# We want the following symmetry: 
#    H(Q𝐫) = D1(Q)' * H(𝐫) * D1(Q)
#          ≈ D1 ⊗ D1 * y   

trans_Y2pp(y) = [ y[1] y[2] y[3]; 
                  y[2] y[3] y[4]; 
                  y[3] y[4] y[5] ] 
