...
struct SimpleACE1{T, RB, YB, AB, AAB, BB}
...
function eval_with_grad(m::SimpleACE1, 𝐫::AbstractVector{<: SVector{3}})
...
#
model = SimpleACE1(rbasis, ybasis, abasis, aabasis, symm, randn(num𝔹) )
